...
function TodoApp(store) {
  ...
  return createElement(
    ...
    createElement(
      "main",
      {class: "main", style: "display: block;", "data-id": },
      createElement(
        "div",
        ...
        createElement(
          "label",
          {class: "toggle-all-label", for: "toggle-all", "data-id": },
        ...
        ...store.state.filteredTodos.map((todo) =>
          createElement(
            ...
            createElement(
              ...
              createElement("label", {"data-id": }, todo.text),
              createElement("button", {class: "destroy", "data-id": })
            )
          )
        )
      )
    ...
    store.state.todos.length
      ? createElement(
          "footer",
          {class: "footer", style: "display: block;", "data-id": },
          createElement(
            "span",
            {class: "todo-count", "data-id": },
            createElement(
              "strong",
              {},
