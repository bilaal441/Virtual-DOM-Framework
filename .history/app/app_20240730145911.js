  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(
          "label",
          {class: "toggle-all-label", for: "toggle-all", "data-id": generateUniqueID},
        ...
        ...store.state.filteredTodos.map((todo) =>
          createElement(
            ...
            createElement(
              ...
              createElement("label", {"data-id": generateUniqueID}, todo.text),
              createElement("button", {class: "destroy", "data-id": generateUniqueID})
            )
          )
        )
      )
    ...
    store.state.todos.length
      ? createElement(
          "footer",
          {class: "footer", style: "display: block;", "data-id": generateUniqueID},
          createElement(
            "span",
