    ...
    createElement(
      ...
      createElement(
        ...
        createElement("input", {
          ...
          onclick: toggleHandler, // Ensure the toggleHandler is attached here
        }),
        createElement(
          "label",
          {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  store = createStore(
    {...initialState, initialState}, // Initialize with filteredTodos
    TodoApp,
    rootElement
  );
