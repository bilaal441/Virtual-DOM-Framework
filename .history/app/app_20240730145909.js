...
function TodoApp(store) {
  ...
  return createElement(
    ...
    createElement(
      "main",
      {class: "main", style: "display: block;", "data-id": ge},
      createElement(
        "div",
        ...
        createElement(
          "label",
          {class: "toggle-all-label", for: "toggle-all", "data-id": ge},
        ...
        ...store.state.filteredTodos.map((todo) =>
          createElement(
            ...
            createElement(
              ...
              createElement("label", {"data-id": ge}, todo.text),
              createElement("button", {class: "destroy", "data-id": ge})
            )
          )
        )
      )
    ...
    store.state.todos.length
      ? createElement(
          "footer",
          {class: "footer", style: "display: block;", "data-id": ge},
          createElement(
            "span",
            {class: "todo-count", "data-id": ge},
            createElement(
              "strong",
              {},
